...
def main(model_type,epochs,optimizer,sparse_targets,patience=None):
    ...
    model = build.buildmodel(model_type,num_labels,frame_width,timesteps,num_features,lstm_cells,feature_map_filters,kernel_size,pool_size,dense_hidden_units,activation_output)
